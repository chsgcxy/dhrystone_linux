...
// Compiler will optimise away part of the Dhrystone loop unless we convince it
// the final values of the variables used in the benchmark might be printed...
int dont_print __attribute__((weak)) = 1;
...
#endif
  {
/*  The following 3 lines commented out by ARM
 *  int n;
 *  scanf ("%d", &n);
 *  Number_Of_Runs = n;
 *
 *  The following 2 lines added by ARM
 */
#ifdef VERBOSE
//    printf("%d", ITERATIONS);
#endif
